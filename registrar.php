...
<head>
    ...
    <title>CajaEnvioRegistrar</title>
...
<div class="container">
    <div class="row cuadroSesionRow">
        <div class="cuadroSesion">
         ...
         <img class="LogoImgS"  src="Img/CAJA2.png" alt="logo"></a>
            <h5>Crear cuenta</h5>
            <div class="m-2">
            ...
            <div class="m-2 btnSesion">
                <input type="submit" name="btnregistrar" value="Resgistrar"><br>
            </div>
            <a class="crear_a" href="index.php">Regresar</a>
        </form>
       </div>
    </div>
</div>
